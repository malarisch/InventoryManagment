    ...
    <div className="grid gap-6 rounded-md border p-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="grid gap-1.5">
          ...
          <Input id="cmf-first" value={local.firstName} onChange={(e) => set("firstName", e.target.value)} />
        </div>
        <div className="grid gap-1.5">
          <Label htmlFor="cmf-last">Nachname</Label>
          <Input id="cmf-last" value={local.lastName} onChange={(e) => set("lastName", e.target.value)} />
        </div>
        <div className="grid gap-1.5">
      ...
      {/* TODO: Implement UI for contactInfo and employees */}
