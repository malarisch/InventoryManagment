...
2025-10-06: Normalize price units. Adjusted PriceFields to display main units but store amount in smallest unit (cents) per Price spec; keeps all formatters (which divide by 100) consistent so 10€ shows as 10,00€. Files: components/forms/metadata/price-fields.tsx.
